...
class CoVe(nn.Module):
    def __init__(self, config):
        ...
        self.rnn = nn.LSTM(self.word_emb_dim, self.rnn_dim, self.nlayers,
    ...
    def forward(self, sent_tuple):
        ...
        if self.pool_type == "mean":
            ...
            emb = torch.cat((sent_output[-1, :, :self.rnn_dim],
                             sent_output[0, :, self.rnn_dim:]), 1)

        else:
            emb = sent_output.transpose(0, 1)
